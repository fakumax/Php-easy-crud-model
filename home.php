        ...
        <div class="container ">
            <div class="d-flex flex-column justify-content-center  text-center homeStyle">
                <ul>
                    ...
                    <li> <a href="pantalla/usuarios/usuarios.php" class="btn btn-dark" role="button" aria-pressed="true">Usuarios</a></li>
                    ...
                    <li> <a href="pantalla/personas/personas.php" class="btn btn-dark" role="button" aria-pressed="true">Personas</a></li>
                </ul>
            </div>
        </div>
    </div>
